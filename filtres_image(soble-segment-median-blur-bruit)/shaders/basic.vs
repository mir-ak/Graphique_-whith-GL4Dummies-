...
out vec4 vsoColor;
/* une autre sortie du vertex shader vers le fragment shader (voir basic.fs, in vec2 vsoTexCoord) */
...
void main(void) {
  ...
  vsoTexCoord = (inv != 0) ? vec2(vsiTexCoord.x, 1.0 - vsiTexCoord.y) : vsiTexCoord;
}
